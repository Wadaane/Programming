...
![Senior](https://github.com/Wadaane/Programming/blob/master/Python/OpenCV/EyeTracking/Images/Senior.png)  
...
- Prior to the detection, we set two variables, left_open and right_open, both equals to zero.  
- During the iterations of the detected eyes, if the detected eye is the left one, we set left_open = 1, and if its the right eye, right_open = 2.  
- After the iteration is finished, we add both values, left_open and right_open, and save it in a variable. Here are the 4 possibilities:  

   #### a. Both eyes closed:
      left_open = 0 and right_open = 0  
      0 + 0 = 0

   #### b. Right blink (only left eye is openned):
      left_open = 1 and right_open = 0  
      1 + 0 = 1

   #### c. Left blink (only right eye is openned):
      left_open = 0 and right_open = 2  
      0 + 2 = 2

   #### d. Both eyes openned:
      left_open = 1 and right_open = 2  
      1 + 2 = 3
...
### 2.4. Calibration: Set Bound Box around Eye.
...
### 2.6. Resize image into 3x3 pixels image:
...
### 2.7. Map the pixel index to direction:
...
At the end of the process, we have extracted at first the blink action, and then the iris location. That information will be sent to the user interface, to control the mouse movement and click events.  
  ...
  ![Eyes](https://github.com/Wadaane/Programming/blob/master/Python/OpenCV/EyeTracking/Images/Eyes.png)  
...
![Preview](https://github.com/Wadaane/Programming/blob/master/Python/OpenCV/EyeTracking/Images/Preview0.png)  
...
![Preview](https://github.com/Wadaane/Programming/blob/master/Python/OpenCV/EyeTracking/Images/Preview1.png)  
...
![Settings](https://github.com/Wadaane/Programming/blob/master/Python/OpenCV/EyeTracking/Images/Settings0.png)  
...
### 3.3 Application View:
  ...
  ![Application](https://github.com/Wadaane/Programming/blob/master/Python/OpenCV/EyeTracking/Images/Applications0.png)  
...
## 4. Circuit
  ...
  ![Circuit](https://github.com/Wadaane/Programming/blob/master/Python/OpenCV/EyeTracking/Images/Circuit.png)  
...
- Command: what to do.  (e.g.: '0' for turn off.)  
...
## 5. How to use it:
   ...
   - On the launch of the program the user is greeted on the Preview page where he need to start the image acquisition.  
   - This is done by clicking on the Start button. A live feed is then shown and the user can see the result and decide if the calibration is correct or not, if the calibration is not satisfying, it can be corrected by pressing the calibrate button.  
